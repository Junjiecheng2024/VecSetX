...
def main(args):
    ...
    dataset_train = Objaverse(split='train', sdf_sampling=True, sdf_size=1024, surface_sampling=True, surface_size=args.point_cloud_size, dataset_folder='/home/user/persistent/vecset/data_npz')
    dataset_val = Objaverse(split='val', sdf_sampling=True, sdf_size=1024, surface_sampling=True, surface_size=args.point_cloud_size, dataset_folder='/home/user/persistent/vecset/data_npz')
